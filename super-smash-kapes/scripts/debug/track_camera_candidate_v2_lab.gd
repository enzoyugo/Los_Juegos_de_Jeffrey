...
## Isolated NON-CANONICAL camera candidate lab. Physics untouched. HUMAN_REVIEW_REQUIRED.
...
const CamScript := preload("res://scripts/track/track_camera_candidate_v2.gd")
