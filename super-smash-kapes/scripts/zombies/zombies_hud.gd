...
func _ready() -> void:
	...
	var round_panel := _asset(root, HUD_ROUND, Vector2(820, 24), Vector2(280, 93))
	_wave = Layout.outlined_label("1", 52, ThemeRef.GOLD, HORIZONTAL_ALIGNMENT_CENTER)
	_wave.position = Vector2(97, 35)
	_wave.size = Vector2(87, 37)
	...
	var points_panel := _asset(root, HUD_POINTS, Vector2(40, 24), Vector2(280, 93))
	_points = Layout.outlined_label("0", 30, ThemeRef.GOLD, HORIZONTAL_ALIGNMENT_CENTER)
	_points.position = Vector2(119, 33)
	_points.size = Vector2(127, 29)
	...
	var health_panel := _asset(root, HUD_HEALTH, Vector2(40, 850), Vector2(520, 173))
	...
	var weapon_panel := _asset(root, HUD_WEAPON, Vector2(1360, 850), Vector2(520, 173))
