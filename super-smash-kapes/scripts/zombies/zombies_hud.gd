...
func _ready() -> void:
	...
	_wave = Layout.outlined_label("1", 72, ThemeRef.GOLD, HORIZONTAL_ALIGNMENT_CENTER)
	...
	Layout.apply_frac(hp_wrap, 0.04, 0.82, 0.28, 0.08)
	...
	_ammo = Layout.outlined_label("10 / 80", 40, ThemeRef.TEXT, HORIZONTAL_ALIGNMENT_RIGHT)
