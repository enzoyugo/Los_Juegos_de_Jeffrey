...
## Scene operation commands: create_scene, read_scene, add_node, remove_node,
## modify_node_property, rename_node, move_node, duplicate_node, reorder_node,
## attach_script, detach_script, set_collision_shape, set_sprite_texture,
## get_scene_hierarchy, get_scene_node_properties, set_scene_node_property
...
func process_command(tool_name: String, args: Dictionary) -> Dictionary:
	match tool_name:
		...
		"set_collision_shape":
			return set_collision_shape(args)
		"set_sprite_texture":
			return set_sprite_texture(args)
		"get_scene_hierarchy":
			return get_scene_hierarchy(args)
		"get_scene_node_properties":
			return get_scene_node_properties(args)
		"set_scene_node_property":
			return set_scene_node_property(args)
	return {&"ok": false, &"error": "Unknown scene command: " + tool_name}
...
func create_scene(args: Dictionary) -> Dictionary:
	...
	return {
		&"ok": true, &"path": scene_path, &"root_type": root_node_type,
...
func _build_node_structure(node: Node, include_props: bool, path: String = ".") -> Dictionary:
	const PROPERTIES: PackedStringArray = [
		"position", "rotation", "scale", "size", "offset", "visible",
...
func add_node(args: Dictionary) -> Dictionary:
	...
	return {
		&"ok": true, &"scene_path": scene_path, &"node_name": node_name,
		&"node_type": node_type,
...
func remove_node(args: Dictionary) -> Dictionary:
	...
	return {
		&"ok": true, &"scene_path": scene_path, &"removed_node": node_path,
...
func modify_node_property(args: Dictionary) -> Dictionary:
	...
	return {
		...
		&"old_value": str(old_value), &"new_value": str(parsed),
...
func rename_node(args: Dictionary) -> Dictionary:
	...
	return {
		&"ok": true, &"old_name": str(old_name), &"new_name": new_name,
...
func reorder_node(args: Dictionary) -> Dictionary:
	...
	return {
		&"ok": true, &"old_index": old_index, &"new_index": new_index,
