...
const CAPTURE_DIR := "E:/PharosVisualization/experiments/track_generation/sprint_018_runtime_drivability/screenshots/"
const EVIDENCE_DIR := "E:/PharosVisualization/experiments/track_generation/sprint_018_runtime_drivability/"
